              ...
              Builder(
                builder: (context) {
                  ...
                  return Wrap(
                    ...
                    alignment:
                        WrapAlignment.center, // Align children within each line
                    runAlignment:
                        WrapAlignment.center, // Align lines vertically
                    children: [
                      ...SortingField.values.map(
                        (field) => OutlinedButton(
                          ...
                          child: Wrap(
                            spacing: 4,
                            children: [
                              if (field == SortingField.date) Text(l10n.date),
                              ...
                              if (field == SortingField.type) Text(l10n.type),
